...
ON_A = 2*60; %ON for aldosterone, units = min 
...
nH_het = 1.183;              %                   ***Optimize this value??
...
kdeg3 = 0.0091;         % Degredation rate of mKate       **Optimize this value

%ec values, dissociation constant 
ec501 = 64; %nM, known from Baker (Est)
ec502 = 200; %nM, known from Baker (Ald)
ec503 = 121; %nM, guess for now

kobs = 1.13e-4;          % Exchange rate parameter from Baker; not precise  **Optimize this value
%% Run ODE
